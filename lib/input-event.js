...
//    console.log(buffer.toString('hex'), " ", buffer.length);
    if (process.arch === 'x64') {
	event = {
	    timeS: buffer.readUInt32LE(0),//avoiding using a lib. 64LE doesnt exist on my installation of nodejs on x64 arch
    ...
    var evtype = event.type; //handle 64 bit as well
//    console.log(event);
